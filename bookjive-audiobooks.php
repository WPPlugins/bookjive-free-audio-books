...
function bookjive_audiobooks_install() {
	...
	//AudioBooks
	$sql = "CREATE TABLE `wordpress`.`{$wpdb->prefix}bookjive_audiobooks` (
	...
	//AudioBooks Tracks
	$sql = "CREATE TABLE `wordpress`.`{$wpdb->prefix}bookjive_audiobook_tracks` (
...
function bookjive_audiobooks_deactivate(){
	...
	//AudioBooks
	$sql = "DROP TABLE `wordpress`.`{$wpdb->prefix}bookjive_audiobooks`";
	$wpdb->query($sql);

	//AudioBooKs Tracks
	$sql = "DROP TABLE `wordpress`.`{$wpdb->prefix}bookjive_audiobook_tracks`";
	$wpdb->query($sql);
